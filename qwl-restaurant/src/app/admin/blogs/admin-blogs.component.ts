...
const emptyForm = (): Omit<AdminBlog, 'id' | 'commentsCount'> => ({
  slug: '', img: '', thumb: '', date: '', author: '', category: 'Recipes', title: '', excerpt: '', tags: [], isPublished: false
});
...
export class AdminBlogsComponent implements OnInit {
  ...
  openEdit(post: AdminBlog): void {
    ...
    this.form.set({ slug: post.slug, img: post.img, thumb: post.thumb, date: post.date, author: post.author, category: post.category, title: post.title, excerpt: post.excerpt, tags: [...post.tags], isPublished: post.isPublished });
    this.tagInput.set('');
    this.modalOpen.set(true);
  }
